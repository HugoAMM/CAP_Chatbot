...
import { BookingDialog } from './dialogs/booking/bookingDialog';
const BOOKING_DIALOG = 'bookingDialog';

// The bot's tramite dialog
import { TramiteDialog } from './dialogs/tramite/tramiteDialog';
const TRAMITE_DIALOG = 'tramiteDialog';

// The helper-class recognizer that calls LUIS
import { FlightBookingRecognizer } from './dialogs/axityRecognizer';
...
const tramiteDialog = new TramiteDialog(TRAMITE_DIALOG);
const dialog = new MainDialog(luisRecognizer, bookingDialog, tramiteDialog);
